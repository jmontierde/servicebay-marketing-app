    ...
    <footer className="bg-muted border-t border-border py-16">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          {/* Product */}
          <div>
            <h3 className="font-semibold font-heading mb-4 text-foreground">Product</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="font-semibold font-heading mb-4 text-foreground">Company</h3>
            <ul className="space-y-2 font-body">
          ...
          {/* Support */}
          <div>
            <h3 className="font-semibold font-heading mb-4 text-foreground">Support</h3>
            <ul className="space-y-2 font-body">
